...
export default function SetupStep({
  ...
  const academicYears = (formOptionsQuery.data as any)?.academicYears ?? [];
  const classSections = (formOptionsQuery.data as any)?.classSections ?? [];

  const filteredSections = classSections.filter(
    (s: any) =>
      String(s.academicYearId) === String(state.setupData.academicYearId)
  );
