...
setHasSearched(true);
  ...
  const params = {
    classLevelId:
      v.classLevelId && v.classLevelId !== "all"
        ? Number(v.classLevelId)
        : undefined,

    academicYearId:
      v.academicYearId && v.academicYearId !== "all"
        ? Number(v.academicYearId)
        : undefined,

    feeType:
      v.feeType && v.feeType !== "all"
        ? v.feeType
        : undefined,

    frequency:
      v.frequency && v.frequency !== "all"
        ? v.frequency
        : undefined,
  };
  ...
  const msg = getApiErrorMessage(
    error,
    "Failed to filter fee structures"
  );
...
Filter Fee Structures </h3>

        <p className="text-sm text-muted-foreground">
          Search fee structures using filters
        </p>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <div className="space-y-1.5">
            ...
            <Select
              ...
              onValueChange={(val) =>
                form.setValue("classLevelId", val)
              }
            >
              <SelectTrigger>
          ...
          <div className="space-y-1.5">
            ...
            <Select
              ...
              onValueChange={(val) =>
                form.setValue("academicYearId", val)
              }
            >
              <SelectTrigger>
